...
const Footer = () => {
  ...
  return (
    <div className="grid grid-cols-2 divide-gray-400 my-3 bg-gray-900 h-10">
      <div className="footer_left site_title text-white p-2 sm:text-base md:text-l lg:text-sm xl:text-sx ">
      ...
      <div className="footer_right site_title text-l text-white p-2">
